...
@Composable
fun card(encomendaDTO: EncomendaDTO) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text("retirada: ${encomendaDTO.dataRetirada ?: "Data não informada"}", color = Color.White, fontSize = 14.sp)
                Text("R$ ${encomendaDTO.preco ?: "Preço indefinido"}" , color = Color.White, fontSize = 14.sp)
...
@Composable
fun telaAdministrador(viewModel: EncomendaViewModel, modifier: Modifier = Modifier) {
